...
function MyAccountButton() {
  ...
  return (
    <>
      ...
      <>
        <div
          className={`transition-all duration-500 absolute z-40 top-20 w-screen ${
            showModal ? "h-screen" : "h-0 overflow-hidden"
          }
            ${
              showModal
                ? "md:h-screen md:bg-gray-800 md:bg-opacity-50 md:z-0 md:top-20"
                : "md:h-0 overflow-hidden"
            }
            ${
              showModal
                ? "lg:h-screen lg:bg-gray-800 lg:bg-opacity-50 lg:z-0 lg:top-20"
             ...
             ${
               showModal
                 ? "2xl:h-screen 2xl:bg-gray-800 2xl:bg-opacity-50 2xl:pr-36 2xl:z-0 2xl:top-20"
                 : "2xl:h-0 overflow-hidden"
             }
            `}
        >
          <div
            className={`w-full relative bg-white h-full
            md:w-5/6 md:h-1/2 md:mx-auto md:mt-10 md:transition-all md:duration-500 ${
